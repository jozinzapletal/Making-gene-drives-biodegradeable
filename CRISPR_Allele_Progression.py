...
data1 = pd.read_csv('CRISPR1-5 Alleles.csv')
gammaList = [0.01]
...
data1.allele[data1.allele == 2] = 'v'
data1.allele[data1.allele == 3] = 'u' 
data1.allele[data1.allele == 4] = 'r'
data1.allele[data1.allele == 5] = 'g' 
data1.allele[data1.allele == 6] = 's'
...
for g in gammaList:
    ...
    for d in alphaList:
        ...
        for b in alleleList:
            ...
            colors = ['steelblue', 'deepskyblue', 'lightskyblue', 'lightblue', 'darkviolet', 'orchid']
